...
namespace IYNet
{
    public class IYTool
    {
        public static byte[] PackNetMsg<T>(T msg) where T : IYMsg
        {
        ...
        public static byte[] Serialize<T>(T msg) where T : IYMsg
        {
        ...
        public static T DeSerialize<T>(byte[] bytes) where T : IYMsg
        {
