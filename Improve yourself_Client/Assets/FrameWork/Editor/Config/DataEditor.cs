...
{
    public static string XmlPath = RealConfig.GetFramConfig().m_XmlPath;
    public static string BinaryPath = RealConfig.GetFramConfig().m_BinaryPath;
    public static string ScriptsPath = RealConfig.GetFramConfig().m_ScriptsPath;
