...
{
    unsafe class AddressableManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::AddressableManager);
            ...
            if (genericMethods.TryGetValue("AsyncLoadResource", out lst))
            {
                foreach(var m in lst)
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(System.String), typeof(System.Action<UnityEngine.Sprite>)))
                    {
            ...
            method = type.GetMethod("AsyncInstantiate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, AsyncInstantiate_1);
        ...
        static StackObject* AsyncLoadResource_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Action<UnityEngine.Sprite> @callback = (System.Action<UnityEngine.Sprite>)typeof(System.Action<UnityEngine.Sprite>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            global::AddressableManager.AsyncLoadResource<UnityEngine.Sprite>(@name, @callback);

            return __ret;
        }

        static StackObject* AsyncInstantiate_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            global::AddressableManager.AsyncInstantiate(@name, @callback);
        ...
        static StackObject* Release_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::AddressableManager.Release(@obj);
