...
namespace ILRuntime.Runtime.Generated
{
    unsafe class Improve_ResourceManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("ReleaseResource", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ReleaseResource_2);
        ...
        static StackObject* ReleaseResource_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            ...
            var result_of_this_method = instance_of_this_method.ReleaseResource(@path, @destoryObj);
