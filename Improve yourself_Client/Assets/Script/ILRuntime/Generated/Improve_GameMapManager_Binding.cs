...
{
    unsafe class Improve_GameMapManager_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Improve.GameMapManager);
        ...
        {
            return Improve.GameMapManager.LoadingProgress;
        }
        ...
        {
            var result_of_this_method = Improve.GameMapManager.LoadingProgress;
        ...
        {
            Improve.GameMapManager.LoadingProgress = (System.Int32)v;
        }
        ...
        static StackObject* AssignFromStack_LoadingProgress_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            Improve.GameMapManager.LoadingProgress = @LoadingProgress;
